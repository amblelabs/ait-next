...
public class DoorEmissiveLayer extends GeoRenderLayer<DoorBlockEntity> {

    private static final int FULLBRIGHT = 0xF000F0;

    public DoorEmissiveLayer(GeoRenderer<DoorBlockEntity> renderer) {
        super(renderer);
    }

    @Override
    public void render(PoseStack poseStack, DoorBlockEntity entity, BakedGeoModel bakedModel,
