...
import dev.amble.ait.common.impl.tardis.behavior.DesktopBehavior;
...
public class AitEcs {
    ...
    public static void initState() {
        ...
        States.register(DesktopState.state);
        States.freeze();
    }

    public static void initEvents() {
        TEventsRegistry.register(ServerLifecycleEvents.event);
        ...
        TEventsRegistry.register(DesktopPlacementEvents.event);
    ...
    public static void initBehavior() {
        ...
        TBehaviorRegistry.register(DesktopBehavior::new);
